   ...
   *     }
...
},{"./lib/game":5}],4:[function(require,module,exports){
    'use strict';
    ...
    function play(game, player, position) {
        ...
        if (move.get('position') === null) {
            return game.update('currentPlayer', _util.opponentColor).update('consectutivePasses', function (p) {
                return p + 1;
            });
        }
        ...
        return game.update('currentPlayer', _util.opponentColor).set('consectutivePasses', 0).set('board', newBoard).update('history', function (h) {
...
},{"./board":4,"./records":6,"./util":7,"immutable":1}],6:[function(require,module,exports){
    'use strict';
