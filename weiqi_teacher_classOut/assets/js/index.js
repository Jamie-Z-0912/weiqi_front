...
(function(Request){
    ...
    Request.getCookies = function(){
        return {
            ...
            //设置账号信息
            setInfo : function(userId, userName, mobile, password, unitId){
    ...
    Request.modal = function(){
        ...
        //初始化
        function initial(){
            _dialog = $('<div />').addClass(_param.className);
            _dialog.append(_modelBody);
            _modelBody.append(_contentBody);
            _body.append(_dialog);
        }
        ...
        function useModal(time = 1000){
            showModal();
            setTimeout(hideModal,time);
        }
